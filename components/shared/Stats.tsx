  ...
  return (
    <div className="mt-10">
      ...
      <div className='mt-5 grid grid-cols-1 gap-5 xs:grid-cols-2 md:grid-cols-4'>
        ...
        <StatsCard imgUrl={GoldMedalIcon} value={0} title="Gold Badges" />
        <StatsCard imgUrl={SilverMedalIcon} value={0} title="Silver Badges" />
        <StatsCard imgUrl={BronzeMedalIcon} value={0} title="Bronze Badges" />
      </div>
    </div>
  )
}
